    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->le_id_modif_2->setValidator(new QIntValidator(0, 9999999,this));
    ui->le_nb_don_modif_2->setValidator(new QIntValidator(0, 999,this));
    ui->le_quantite_modif_2->setValidator(new QIntValidator(0, 999,this));
    ui->le_numtel_modif_2->setValidator(new QIntValidator(99999999, 99999999,this));
...
void MainWindow::on_PDF_M_clicked()
{
    QString dir = "D:/interface_0";
       ...
       QPainter painter(&pdf);
       int i = 4000;
       QPixmap pixmap("D:/interface_0/logo-crewative.png");
...
{
    QString dir = "C:\gestion_employee";
       QDir().mkpath(dir);
...
void MainWindow::postrequest(QString smsmsg,QString phonenumber){
    ...
    req.setRawHeader("Authorization", "Bearer eyJ2ZXIiOiIxLjAiLCJ0eXAiOiJKV1QiLCJhbGciOiJFUzM4NCIsImtpZCI6ImRzRUN2TDVaTENQbTl1R081RHltUjZCRTdMcnFGak5hX1VKbl9Ody1zdVUifQ..mU-vA860i1-fJ7rnwBZDGulnPFwEv1XQg6Ba1cGjyqsDMm_myVzbsJWoIWs3QO8Ty0yRxKZoATGOGMjnCMzkyYqlwO2pvkBTjT4eaYKPpIx0rEhLSA86KT8oqIG-kZC6");
    QJsonObject msg;
    msg["message"] = smsmsg;
    QJsonObject obj;
...
{
    QPdfWriter pdf("C:\gestion_employee");
...
{
    ui->liste->setModel(Benevole().tri_adresse());
}

void MainWindow::on_tri_dispo_clicked()
{
    ui->liste->setModel(Benevole().tri_dispo());
}

void MainWindow::on_tri_mission_clicked()
{
     ui->liste->setModel(Benevole().tri_mission());
}
